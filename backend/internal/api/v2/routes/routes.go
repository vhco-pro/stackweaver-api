...
func SetupV2Routes(
	...
	notificationHandler := terraformHandlers.NewNotificationConfigurationHandlerV2(notificationCfgRepo, workspaceRepo, authService, rbacService, atRestCrypto, notificationSvc)
