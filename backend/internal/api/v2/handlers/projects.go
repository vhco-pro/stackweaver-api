...
func NewProjectHandlerV2(projectRepo *repository.ProjectRepository, orgRepo *repository.OrganizationRepository, teamRepo *repository.TeamRepository, agentPoolRepo *repository.AgentPoolRepository, authService *auth.Service, activityService *activity.Service, rbacService *rbac.Service) *ProjectHandlerV2 {
